...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Instruct>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.InstructorId, e.CourseId }, "UQ__instruct__029B7EDA2660E1EA")
                    .IsUnique();
            ...
            modelBuilder.Entity<Review>(entity =>
            {
                ...
                entity.HasOne(d => d.Course)
                    ...
                    .HasForeignKey(d => d.CourseId)
                    .HasConstraintName("FK__review__courseID__6477ECF3");

                entity.HasOne(d => d.Learner)
                    .WithMany(p => p.Reviews)
                    .HasForeignKey(d => d.LearnerId)
                    .HasConstraintName("FK__review__learnerI__656C112C");
            });
